...
st.set_page_config(page_title="Admin — Race Hub", layout="wide")
show_header("Race Hub Admin", "Pending submissions and operational review")

st.warning(
    "Admin v1 is not password-protected yet. Do not share the app link publicly while admin tools are visible."
)
...
with tab_notes:
    ...
    st.write(
        ...
        3. Move approved entries into confirmed event entries.
        4. Add payment status tracking.
        5. Add contact status tracking.
        """
    )